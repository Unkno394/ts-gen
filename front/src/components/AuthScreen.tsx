      ...
      <section className="auth-layout auth-layout-redesign">
        <aside className="auth-hero auth-hero-redesign">
          ...
          <div className="auth-hero-copy">
            ...
            <h2>TSGen учится на каждой генерации.</h2>
            <p className="subtle-text auth-hero-text">
              Аккаунты, история генераций, сохранённые схемы и обучающие данные теперь живут в одном проектном слое, поэтому TSGen работает как единое приложение с общей памятью, а не как набор разрозненных локальных сессий.
            </p>
          </div>
          ...
          <div className="auth-feature-list glass-card auth-feature-list-redesign">
            ...
            <div className="auth-feature-item">
              ...
              <div>
                <strong>Обучающая память</strong>
                <span>Подтверждённые соответствия и правки сохраняются, чтобы следующие генерации были точнее с первого прогона.</span>
              </div>
            </div>
          </div>
        </aside>
